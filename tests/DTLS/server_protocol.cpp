...
void Server_Protocol::process_message(uint8_t msg_id, uint16_t cmd, QIODevice &data_dev)
{
...
void Server_Protocol::process_answer_message(uint8_t msg_id, uint16_t cmd, QIODevice &data_dev)
{
...
void Server_Protocol::process_answered(bool value1, uint32_t value2, uint16_t cmd, uint8_t msg_id)
{
