...
{
public:
    Server(Tools* dtls_tools, boost::asio::io_context *io_context, uint16_t port, Create_Protocol_Func_T&& create_protocol_func, std::chrono::seconds cleaning_timeout, int record_thread_count = 5);
